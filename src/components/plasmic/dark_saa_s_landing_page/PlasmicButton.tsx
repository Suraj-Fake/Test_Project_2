...
import sty from "./PlasmicButton.module.css"; // plasmic-import: IJxXxfpIqlWa/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__aGUx)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__jdTxd)}
                role={"img"}
              />
            ),
