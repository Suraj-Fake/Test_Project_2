...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: w17PIyjbmmf8/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___5BxPo)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__k4Mfv)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__wiDcc)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__okzVu)}>
          <div className={classNames(projectcss.all, sty.freeBox__vcBj4)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard__ylVQ)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox___9VXxM)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard___42PL)}
          />
        </div>
      </p.Stack>
    </div>
