...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: rOTxkK6IxvJV/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__s8NZu)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__unByd)}>
            <h5
